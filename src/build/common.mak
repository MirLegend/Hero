...
ifndef INSTALL_DIR
ifeq ($(IS_COMMAND),1)
	OUTPUTDIR = $(KBE_ROOT)/bin/server/commands
else
	OUTPUTDIR = $(KBE_ROOT)/bin/server
endif # IS_COMMAND == 1
else # INSTALL_DIR
...
MAKE_LIBS=1
ifndef OUTPUTDIR
	OUTPUTDIR = $(KBE_ROOT)/bin/server/$(COMPONENT)-extensions
endif # OUTPUTDIR
...
OUR_CC = $(addsuffix .cc, $(SRCCC))
OUR_ASMS = $(addsuffix .s, $(ASMS))
ALL_SRC = $(SRCS) $(CSRCS) $(ASMS) $(SRCCC)
...
LDFLAGS += -L$(LIBDIR)
KBE_INCLUDES += -I $(KBE_ROOT)/src
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib
KBE_INCLUDES += -I $(KBE_ROOT)/src/server
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib/dependencies
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib/dependencies/tinyxml
...
ifdef USE_PYTHON
USE_KBE_PYTHON = 1
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib/python/Include
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib/python
...
KBE_INCLUDES += -I $(KBE_ROOT)/src/lib/dependencies/log4cxx/src/main/include
...
OPENSSL_DIR = $(KBE_ROOT)/src/lib/dependencies/openssl
...
G3DMATH_DIR = $(KBE_ROOT)/src/lib/dependencies/g3dlite
...
SIGAR_DIR = $(KBE_ROOT)/src/lib/dependencies/sigar
...
#JWSMTP_DIR = $(KBE_ROOT)/src/lib/dependencies/jwsmtp
...
#TMXPARSER_DIR = $(KBE_ROOT)/src/lib/dependencies/tmxparser
...
#ZIP_DIR = $(KBE_ROOT)/src/lib/dependencies/zip
...
JEMALLOC_DIR = $(KBE_ROOT)/src/lib/dependencies/jemalloc
...
$(MY_LIBNAMES): always
	$(MAKE) -C $(KBE_ROOT)/src/lib/$(subst XXXXX,_lib,$(subst lib,,$(subst _lib,XXXXX,$(*F)))) \
...
$(foreach dd,$(call grep,/,$(SRCCC)),$(eval vpath $(notdir $(dd)).cc $(dir $(dd))))
