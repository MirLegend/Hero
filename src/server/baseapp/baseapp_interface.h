...
NETWORK_INTERFACE_DECLARE_BEGIN(BaseappInterface)
	...
	SERVER_MESSAGE_DECLARE_STREAM(BaseApp, MSGIDMAKE(6, 7), onWriteToDBCallback, NETWORK_VARIABLE_MESSAGE)
	...
	SERVER_MESSAGE_DECLARE_STREAM(BaseApp, MSGIDMAKE(91, 7), onClientUpMsg, NETWORK_VARIABLE_MESSAGE)
